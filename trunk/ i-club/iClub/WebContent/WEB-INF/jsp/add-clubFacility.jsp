...
<div id="content">
<form:form modelAttribute="clubFacility" action="add-clubFacility.do" method="POST">
<table width="67%" border="0" align="left">
  <tr>
    <td>Club</td>
    <td><form:select itemValue="clubId" itemLabel="clubLongName" path="clubId" items="${clubList}" /></td>
  </tr>
  <tr>
  <tr>
    <td>Facility</td>
