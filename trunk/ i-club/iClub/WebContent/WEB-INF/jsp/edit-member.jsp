...
<div id="content">
<form:form modelAttribute="person" action="edit-member.do" method="POST">
<table width="67%" border="0" align="left">
  ...
  <tr>
    ...
    <td align="right"><input type="submit" name="button" id="button" value=" Save " />
      <input type="submit" value="Delete" onclick="this.form.action='delete-member.do';this.form.method='POST';this.form.submit();"/>
